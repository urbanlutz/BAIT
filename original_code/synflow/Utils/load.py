...
def pruner(method):
    prune_methods = {
        ...
        'ensemble' : pruners.Ensemble,
        'uprune' : pruners.UPrune,
        'RandomForestPlus' : pruners.RandomForestPruner,
        'SGDPlus' : pruners.SGDPruner,
        'MLPPlus' : pruners.MLPPruner,
        'DecisionTreePlus' : pruners.DecisionTreePruner,
        'AdaBoostPlus' : pruners.AdaBoostPruner,
        'GradientBoostingPlus' : pruners.GradientBoostingPruner,
        'PyTorchModelPlus': pruners.PyTorchModelPruner,
        'RandomForest' : pruners.PureRandomForestPruner,
        'SGD' : pruners.PureSGDPruner,
        'LinearRegression' : pruners.PureLinearPruner,
        'MLP' : pruners.PureMLPPruner,
        'DecisionTree' : pruners.PureDecisionTreePruner,
        'AdaBoost' : pruners.PureAdaBoostPruner,
        'GradientBoosting' : pruners.PureGradientBoostingPruner,
        'PyTorchModel': pruners.PurePyTorchModelPruner,
    }
    algos = [pruners.SynFlow, pruners.SNIP, pruners.GraSP, pruners.Mag, pruners.Rand]
    for a, b in product(algos, algos):
        class_ = pruners.getStackedClass(a, b)
        prune_methods.update({class_.__name__: class_})
